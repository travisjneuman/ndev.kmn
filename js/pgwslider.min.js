  ...
  a.fn.pgwSlider = function (n) {
      ...
      l.resizeEvent = setTimeout(function () {
        ...
        if (typeof p != "undefined" && p && l.config.maxHeight == null) {
          if (typeof l.plugin.find(".ps-current").animate == "function") {
            l.plugin
              .find(".ps-current")
              .animate({ height: o }, l.config.adaptiveDuration, function () {
                l.plugin
                  .find(".ps-list > li")
                  .animate({ height: q }, l.config.adaptiveDuration);
              });
          } else {
    ...
    var e = function () {
      ...
      l.plugin.find(".ps-list > li").each(function () {
        ...
        if (q.link) {
          p.html(
            '<a href="' +
              q.link +
              '"' +
              (q.linkTarget ? ' target="' + q.linkTarget + '"' : "") +
              ">" +
              p.html() +
              "</a>",
          );
        ...
        if (
          l.config.selectionMode == "mouseOver" &&
          l.config.transitionEffect == "fading"
        ) {
          a(this)
            .css("cursor", "default")
            .click(function (r) {
      ...
      l.plugin.find(".ps-current > ul > li.elt_1 img").on("load", function () {
        ...
        l.window.resize(function () {
          c();
          var q = l.plugin
            .find(".ps-current > ul > li.elt_" + l.currentSlide + " img")
            .height();
      ...
      if (l.config.touchControls && l.slideCount > 1) {
        l.plugin.find(".ps-current").on("touchstart", function (p) {
          try {
            if (
              p.originalEvent.touches[0].clientX &&
              l.touchFirstPosition == null
            ) {
    ...
    var j = function (o) {
      ...
      if (q != "") {
        if (o.link) {
          q =
            ...
            o.link +
            '"' +
            (o.linkTarget ? ' target="' + o.linkTarget + '"' : "") +
            ">" +
            q +
            "</a>";
        }
      ...
      if (l.config.displayControls) {
        if (
          typeof l.plugin.find(".ps-current > .ps-prev").fadeIn == "function"
        ) {
          l.plugin
            .find(".ps-current > .ps-prev, .ps-current > .ps-next")
            .fadeIn(l.config.transitionDuration / 2);
        } else {
          l.plugin
            .find(".ps-current > .ps-prev, .ps-current > .ps-next")
            .show();
    ...
    var d = function (r) {
      ...
      p.css("position", "absolute")
        .show()
        .animate({ opacity: 1 }, l.config.transitionDuration, function () {
    ...
    var k = function (s, v) {
      ...
      if (l.currentSlide == 0) {
        r.find(".elt_1")
          .css({ position: "", left: "", opacity: 1, "z-index": 2 })
          .show();
        ...
        q.css("position", "absolute")
          ...
          .css("opacity", 1)
          .show()
          .animate({ left: 0 }, l.config.transitionDuration, function () {
    ...
    var i = function (o, q, r) {
      ...
      if (typeof l.plugin.find(".ps-caption").fadeOut == "function") {
        l.plugin
          .find(".ps-caption, .ps-prev, .ps-next")
          .fadeOut(l.config.transitionDuration / 2);
      } else {
    ...
    l.destroy = function (o) {
      ...
      if (typeof o != "undefined") {
        ...
        l.plugin
          .find(".ps-list")
          .addClass(l.config.mainClassName)
          .removeClass("ps-list");
